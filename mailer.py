...
class MessageTemplate:
    """Write an HTML table to the file_stream object"""
...
def test():
    test_mailer = SSLMailer("shinari.websitewelcome.com", 465, "support@myzensend.com", "Paso93447", "files/email_template.txt")
